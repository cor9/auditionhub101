          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            ...
            <div className="flex items-center justify-center">
              <img
                ...
                src="https://images.pexels.com/photos/8942628/pexels-photo-8942628.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
              />
            </div>
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Join hundreds of parents who are streamlining their child's
                acting career with Audition Hub 101.
              </p>
            </div>
          </div>
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-3">
            <TestimonialCard
              quote="This app has been a game-changer for managing my daughter's acting career. We never miss an audition now!"
              author="Sarah T."
              role="Parent of Child Actor"
            />
            <TestimonialCard
              quote="The expense tracking alone is worth the subscription. Tax season is so much easier now!"
              author="Michael R."
              role="Father & Manager"
            />
            <TestimonialCard
              quote="The coaching sessions have improved my son's callback rate by 30%. Incredible value!"
              author="Jessica L."
              role="Mother of 8-year-old Actor"
            />
          </div>
        </div>
      </section>
...
function TestimonialCard({ quote, author, role }: TestimonialCardProps) {
  return (
    <div className="rounded-lg border bg-card p-6 shadow-sm">
      <div className="flex flex-col space-y-4">
        <div className="text-lg italic text-card-foreground">"{quote}"</div>
